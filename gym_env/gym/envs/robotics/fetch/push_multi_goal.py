...
class FetchMultiGoalPushEnv(fetch_multi_goal_env.FetchMultiGoalEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', num_goals=2):
        ...
        fetch_multi_goal_env.FetchMultiGoalEnv.__init__(
            self, 'fetch/push_multi_goal.xml', has_object=True, block_gripper=True, n_substeps=20,
