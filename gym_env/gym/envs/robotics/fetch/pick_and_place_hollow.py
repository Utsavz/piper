...
from gym.envs.robotics import fetch_env_hollow


# Ensure we get the path separator correct on windows
MODEL_XML_PATH = os.path.join('fetch', 'pick_and_place_hollow.xml')


class FetchPickAndPlaceHollowEnv(fetch_env_hollow.FetchEnv, utils.EzPickle):
    def __init__(self, reward_type='dense'):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
            'robot0:slide2': 0.0,
            'stand:joint': [1.37, 0.75, 0.45, 1., 0., 0., 0.],
            'plate:joint': [1.15, 0.75, 0.4, 1., 0., 0., 0.],
        ...
        fetch_env_hollow.FetchEnv.__init__(
